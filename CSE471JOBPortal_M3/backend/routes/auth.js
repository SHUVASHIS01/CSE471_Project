...
router.post('/reset-password', async (req, res) => {
  try {
    ...
    const { createPasswordChangedNotification } = require('../services/notificationService');
    try {
      ...
      console.error('❌ Error creating password change notification:', notifError.message);
